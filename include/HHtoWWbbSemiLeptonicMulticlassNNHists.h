...
public:
 ...
 protected:
  ...
  TH1F *NN_mbb, *NN_mlnu, *NN_mqq, *NN_DeltaRlnu, *NN_DeltaRbb, *NN_DeltaRqq, *NN_minDeltaRlj, *NN_minDeltaRbj, *NN_minDeltaRjj, *NN_HT, *NN_NBTag, *NN_NAk4, *NN_mtop_lep1, *NN_mtop_lep2, *NN_mtop_had1, *NN_mtop_had2;
